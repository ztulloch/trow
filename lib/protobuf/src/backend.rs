...
// see codegen.rs for the explanation why impl Sync explicitly
unsafe impl ::std::marker::Sync for CommitLayer {}

impl CommitLayer {
    pub fn new() -> CommitLayer {
        ::std::default::Default::default()
    }

    pub fn default_instance() -> &'static CommitLayer {
        static mut instance: ::protobuf::lazy::Lazy<CommitLayer> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const CommitLayer,
        };
        unsafe {
            instance.get(CommitLayer::new)
        }
    }
...
impl ::protobuf::Message for CommitLayer {
    fn is_initialized(&self) -> bool {
        true
    }
...
impl ::protobuf::MessageStatic for CommitLayer {
    fn new() -> CommitLayer {
        CommitLayer::new()
    }

    fn descriptor_static(_: ::std::option::Option<CommitLayer>) -> &'static ::protobuf::reflect::MessageDescriptor {
        static mut descriptor: ::protobuf::lazy::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ::protobuf::reflect::MessageDescriptor,
        };
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "uuid",
                    CommitLayer::get_uuid_for_reflect,
                    CommitLayer::mut_uuid_for_reflect,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "digest",
                    CommitLayer::get_digest_for_reflect,
                    CommitLayer::mut_digest_for_reflect,
                ));
                ::protobuf::reflect::MessageDescriptor::new::<CommitLayer>(
                    "CommitLayer",
                    fields,
                    file_descriptor_proto()
                )
...
impl ::protobuf::Clear for CommitLayer {
    fn clear(&mut self) {
        self.clear_uuid();
        self.clear_digest();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for CommitLayer {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for CommitLayer {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x18\x01\x20\x01(\tR\x04uuid\"9\n\x0bCommitLayer\x12\x12\n\x04uuid\x18\
    \x01\x20\x01(\tR\x04uuid\x12\x16\n\x06digest\x18\x02\x20\x01(\tR\x06dige\
    st\"7\n\x08UuidList\x12+\n\x05uuids\x18\x01\x20\x03(\x0b2\x15.lycaon.Gen\
    UuidResultR\x05uuids2\xc5\x02\n\x07Backend\x129\n\x0blayerExists\x12\r.l\
    ycaon.Layer\x1a\x19.lycaon.LayerExistsResult\"\0\x121\n\x07GenUuid\x12\r\
    .lycaon.Layer\x1a\x15.lycaon.GenUuidResult\"\0\x125\n\nUuidExists\x12\
    \x15.lycaon.GenUuidResult\x1a\x0e.lycaon.Result\"\0\x12/\n\x0ccancelUplo\
    ad\x12\r.lycaon.Layer\x1a\x0e.lycaon.Result\"\0\x125\n\x0ccommitUpload\
    \x12\x13.lycaon.CommitLayer\x1a\x0e.lycaon.Result\"\0\x12-\n\x08getUuids\
    \x12\r.lycaon.Empty\x1a\x10.lycaon.UuidList\"\0J\xa3\x12\n\x06\x12\x04\0\
    \0L\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\x03\x02\x08\
    \x0e\n\xdc\x01\n\x02\x04\0\x12\x04\x0b\0\x0f\x012\xcf\x01\x20The\x20back\
    end\x20Protobuf\x20protocol\x20is\x20used\x20between\x20the\x20Client-fa\
    cing\n\x20frontend\x20and\x20the\x20Business-logic\x20backend.\n\n\x20A\
    \x20single\x20service\x20defines\x20the\x20legal\x20rpc\x20calls\x20that\
    \x20can\x20be\x20made\x20to\n\x20the\x20backend\x20from\x20the\x20Fronte\
    ...
    \x03\x12\0\x10\x1a2\x20An\x20Empty\x20message\x20used\x20where\x20no\x20\
    inputs\x20are\x20needed\n\n\n\n\x03\x04\x01\x01\x12\x03\x12\x08\r\n5\n\
    \x02\x04\x02\x12\x04\x15\0\x18\x01\x1a)\x20A\x20generic\x20success/fail\
    \x20response\x20message\n\n\n\n\x03\x04\x02\x01\x12\x03\x15\x08\x0e\n\
    ...
    \x05\x12\x04+\0.\x01\x1aP\x20This\x20message\x20contains\x20both\x20the\
    \x20expected\x20Uuid\x20and\x20digest\x20of\x20an\n\x20uploaded\x20layer\
    ...
    \x05\x02\x01\x12\x03-\x02\x14\n\r\n\x05\x04\x05\x02\x01\x04\x12\x04-\x02\
    ,\x12\n\x0c\n\x05\x04\x05\x02\x01\x05\x12\x03-\x02\x08\n\x0c\n\x05\x04\
    \x05\x02\x01\x01\x12\x03-\t\x0f\n\x0c\n\x05\x04\x05\x02\x01\x03\x12\x03-\
    \x12\x13\n&\n\x02\x04\x06\x12\x042\04\x01\x1a\x1a\x20A\x20list\x20of\x20\
    Uuids\n\x20:Admin:\n\n\n\n\x03\x04\x06\x01\x12\x032\x08\x10\n\x0b\n\x04\
    \x04\x06\x02\0\x12\x033\x02#\n\x0c\n\x05\x04\x06\x02\0\x04\x12\x033\x02\
    \n\n\x0c\n\x05\x04\x06\x02\0\x06\x12\x033\x0b\x18\n\x0c\n\x05\x04\x06\
    \x02\0\x01\x12\x033\x19\x1e\n\x0c\n\x05\x04\x06\x02\0\x03\x12\x033!\"\n\
    \n\n\x02\x06\0\x12\x046\0L\x01\n\n\n\x03\x06\0\x01\x12\x036\x08\x0f\nZ\n\
    \x04\x06\0\x02\0\x12\x039\x028\x1aM\x20-----\x20Image\x20Upload\x20Flow\
    \x20----------\n\x20Check\x20if\x20a\x20layer\x20exists\x20in\x20the\x20\
    Registry\n\n\x0c\n\x05\x06\0\x02\0\x01\x12\x039\x06\x11\n\x0c\n\x05\x06\
    \0\x02\0\x02\x12\x039\x13\x18\n\x0c\n\x05\x06\0\x02\0\x03\x12\x039#4\n=\
    \n\x04\x06\0\x02\x01\x12\x03<\x020\x1a0\x20Generate\x20a\x20uuid\x20for\
    \x20a\x20new\x20layer\x20being\x20uploaded\n\n\x0c\n\x05\x06\0\x02\x01\
    \x01\x12\x03<\x06\r\n\x0c\n\x05\x06\0\x02\x01\x02\x12\x03<\x0f\x14\n\x0c\
    \n\x05\x06\0\x02\x01\x03\x12\x03<\x1f,\nC\n\x04\x06\0\x02\x02\x12\x03?\
    \x024\x1a6\x20Given\x20a\x20Uuid,\x20check\x20whether\x20it\x20exists\
    \x20in\x20the\x20cluster\n\n\x0c\n\x05\x06\0\x02\x02\x01\x12\x03?\x06\
    \x10\n\x0c\n\x05\x06\0\x02\x02\x02\x12\x03?\x12\x1f\n\x0c\n\x05\x06\0\
    \x02\x02\x03\x12\x03?*0\n^\n\x04\x06\0\x02\x03\x12\x03C\x02.\x1aQ\x20Can\
    cel\x20a\x20pending\x20upload\n\x20The\x20digest\x20field\x20is\x20used\
    \x20for\x20the\x20uuid\x20in\x20this\x20rpc\x20call\n\n\x0c\n\x05\x06\0\
    \x02\x03\x01\x12\x03C\x06\x12\n\x0c\n\x05\x06\0\x02\x03\x02\x12\x03C\x14\
    \x19\n\x0c\n\x05\x06\0\x02\x03\x03\x12\x03C$*\n\x0b\n\x04\x06\0\x02\x04\
    \x12\x03E\x024\n\x0c\n\x05\x06\0\x02\x04\x01\x12\x03E\x06\x12\n\x0c\n\
    \x05\x06\0\x02\x04\x02\x12\x03E\x14\x1f\n\x0c\n\x05\x06\0\x02\x04\x03\
    \x12\x03E*0\nu\n\x04\x06\0\x02\x05\x12\x03K\x02,\x1a7\x20returns\x20a\
    \x20list\x20of\x20all\x20Uuids\x20currently\x20in\x20the\x20\x20backend\
    \n2/\x20------------\x20Admin\x20calls\x20--------------------\n\n\x0c\n\
    \x05\x06\0\x02\x05\x01\x12\x03K\x06\x0e\n\x0c\n\x05\x06\0\x02\x05\x02\
    \x12\x03K\x10\x15\n\x0c\n\x05\x06\0\x02\x05\x03\x12\x03K\x20(b\x06proto3\
";
